...
import { editUser, putUser } from "../../redux/actions/userActions";
...
const UserDetail = () => {
  ...
  const { id, name, email, address, phoneNumber } = useSelector(
    (state) => state.session.userDetail
  );
  return (
    <Formik
      initialValues={{
      ...
      <Form>
        ...
        <Container fluid={true}>
          <Row lg="2">
            ...
            <Col lg="12 d-flex justify-content-center pt-5">
              <div className="userDetail__buttons">
                <ButtonBlock style={{ margin: "1rem" }}>
                  Actualizar Datos
                </ButtonBlock>
              </div>
            </Col>
